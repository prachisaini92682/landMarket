            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <Image src={Logo} className='block h-8 w-auto lg:hidden' alt="LandMarket"  />
                  <Link href={'/'} className='hidden md:flex space-x-2 items-center font-sans font-semibold' >
                    <Image src={Logo} className='hidden h-8 w-auto lg:block' alt="LandMarket"  />
                    <span className="text-black" >LandMarket</span>
                  </Link>
                </div>
